...
// Pitch,Stories,DamageType,DamageLocation,MeasureAssist
                                ...
                                //   child: FutureBuilder(
                                //     future: future_get_claimId,
                                //     builder: (context,
                                //         AsyncSnapshot<ModelGetClaimId> snapshot) {
                                ...
                                //                 return claimDetail(
                                //                   "${claim.carrierName}",
                                //                   "${claim.catastropheEvent}",
                                //                   "${claim.reInspection}",
                                //                   "${claim.serviceType}",
                                //                   "${claim.inspectionTime}",
                                //                   "${claim.pitch}",
                                //                   "${claim.stories}",
                                //                   "${claim.isDamageType}",
                                //                   "${claim.isDamageLocation}",
                                //                   "${claim.measureassistNone}",
                                //                 );
                                //               },
                                //             ),
                                //           ),
