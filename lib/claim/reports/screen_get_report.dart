...
import 'package:claim_core/claim/reports/screen_camera.dart';
...
class ScreenGetReport extends StatefulWidget {
  ...
  const ScreenGetReport(
      {required this.modelGetReport, required this.modelAllDropdown});

  @override
  _ScreenGetReportState createState() => _ScreenGetReportState();
}

class _ScreenGetReportState extends State<ScreenGetReport> {
    ...
    GestureTapCallback onTapSubmit = () {
      ...
      Map<String, dynamic> valueMap = {
        "claimReportModel": {
          "id": 0,
          "claimId":
              widget.modelGetReport.data!.assignedClaim!.claimId.toString(),
          // "claimId": 24,
          "inspectorID": "string",
          "assignId": widget.modelGetReport.data!.assignedClaim!.id.toString(),
          // "assignId": 6,
          "claimPersonName": "string",
          "roof_Type": {
            "id": roof_type_fullobject!.id,
            "key": roof_type_fullobject!.key,
            "value": roof_type_fullobject!.value,
            "dropDown": roof_type_fullobject!.dropDown,
            "isActive": roof_type_fullobject!.isActive,
          ...
          "roofStyle_Type": {
            ...
            "value": roof_style_fullobject!.value,
            "dropDown": roof_style_fullobject!.dropDown,
            "isActive": roof_style_fullobject!.isActive,
            "createdBy": roof_style_fullobject!.createdBy,
            "createdDate": "2022-04-25T17:38:28.954Z"
          },
          "layer": layers,
          "edgeMetal_Type": {
            "id": edge_metal_fullobject!.id,
            "key": edge_metal_fullobject!.key,
            "value": edge_metal_fullobject!.value,
            "dropDown": edge_metal_fullobject!.dropDown,
            "isActive": edge_metal_fullobject!.isActive,
            "createdBy": edge_metal_fullobject!.createdBy,
            "createdDate": "2022-04-25T17:38:28.954Z"
          },
          "pitch_Type": {
            "id": 0,
          ...
          "isIceWaterShieldPresent":
              IceWaterShieldPresent == "Yes" ? true : false,
          "mortgageeName": "string",
          "differentClaimantName": "string",
          "dateofLoss": date_of_loss,
          "dwelling": {
            "id": dwelling_fullobject!.id,
            "key": dwelling_fullobject!.key,
            "value": dwelling_fullobject!.value,
            "dropDown": dwelling_fullobject!.dropDown,
            "isActive": dwelling_fullobject!.isActive,
            "createdBy": dwelling_fullobject!.createdBy,
            "createdDate": "2022-04-25T17:38:28.954Z"
          },
          "dwellingMaterial": {
            "id": dwelling_material_fullobject!.id,
            "key": dwelling_material_fullobject!.key,
            "value": dwelling_material_fullobject!.value,
            "dropDown": dwelling_material_fullobject!.dropDown,
            "isActive": dwelling_material_fullobject!.isActive,
            "createdBy": dwelling_material_fullobject!.createdBy,
            "createdDate": "2022-04-25T17:38:28.954Z"
          },
          "dwellingType": {
            "id": dwelling_type_fullobject!.id,
            "key": dwelling_type_fullobject!.key,
            "value": dwelling_type_fullobject!.value,
            "dropDown": dwelling_type_fullobject!.dropDown,
            "isActive": dwelling_type_fullobject!.isActive,
            "createdBy": dwelling_type_fullobject!.createdBy,
            "createdDate": "2022-04-25T17:38:28.954Z"
          },
          "stories": stories,
          "garage": garage,
          ...
          "attached": _attached,
          "garageMaterial": {
            "id": garage_material_fullobject!.id,
            "key": garage_material_fullobject!.key,
            "value": garage_material_fullobject!.value,
            "dropDown": garage_material_fullobject!.dropDown,
            "isActive": garage_material_fullobject!.isActive,
  ...
  Widget GetAppBar() {
    return Row(
      children: [
        ...
        widget.modelGetReport.data!.claimReportModel!.id != 0
            ? InkWell(
                onTap: () async {
                  //TODO
