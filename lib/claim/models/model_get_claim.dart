...
ModelGetClaim modelGetClaimFromMap(String str) =>
    ModelGetClaim.fromMap(json.decode(str));

String modelGetClaimToMap(ModelGetClaim data) => json.encode(data.toMap());
...
class ModelGetClaim {
  ...
  factory ModelGetClaim.fromMap(Map<String, dynamic> json) => ModelGetClaim(
        data: json["data"] == null
            ? null
            : List<DataSingleClaim>.from(
                json["data"].map((x) => DataSingleClaim.fromMap(x))),
      );
...
class DataSingleClaim {
  ...
  factory DataSingleClaim.fromMap(Map<String, dynamic> json) => DataSingleClaim(
